...
export const PL_CV: CvData = {
  ...
  employee: {
    ...
    about:
      'Jestem programistą fullstack z wieloletnim stażem, zajmującym się technologiami Web oraz mobilnymi. W codziennej pracy duży nacisk kładę na czytelność i jakość tworzonego kodu. Stosuje powszechnie sprawdzone reguły CleanCode, SOLID, KISS, DRY. Jestem zwolennikiem testów automatycznych, konteneryzacji oraz pracy w środowisku ciągłej integracji. Na co dzień, w zależności od potrzeb/projektu, pracuję w roli pełnoprawnego programisty backend i/lub frontend. Nierzadko występuje w roli lidera i mentora zespołu programistów. Zdarza mi się również pełnić rolę architekta.',
    skills: [
